...
ActiveRecord::Schema.define(:version => 22) do
  ...
  create_table "accounts", :force => true do |t|
    ...
    t.string  "account_type", :limit => 30, :null => false
  end
  ...
  create_table "reconciliations", :force => true do |t|
    ...
    t.datetime "created_at",                                            :null => false
    t.datetime "updated_at",                                            :null => false
    t.integer  "target_amount_dt_cents"
    t.string   "target_amount_dt_currency", :limit => 6
    t.integer  "target_amount_ct_cents"
    t.string   "target_amount_ct_currency", :limit => 6
  end
  ...
  add_index "txn_accounts", ["txn_id", "position"], :name => "by_txn_position"
